...
| **논문** | 김병현(팀장) | Analyzing and improving the image | NeRF: Representing Scenes as Neural Radiance Fields for View Synthesis | 조경진 | 이예은 |
| **논문** | 김병현(팀장) | StyleSpace Analysis | 김준철 | 조경진 | 이예은 |
| **논문** | 김병현(팀장) | Transfer Learning for Pose Estimation of Illustrated Characters  | 김준철 | 조경진 | 이예은 |
